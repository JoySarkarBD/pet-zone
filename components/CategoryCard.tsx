...
export const CategoryCard = ({
  ...
  <div className={`w-full h-[450px] rounded-[30px] overflow-hidden shadow-lg ${bgColor} relative`}>
    {/* Image Section */}
    ...
    <div
      ...
      style={{ backgroundImage: `url(${cloudImageSrc})`, height: `${vectorHeight}px` }} // Inline height
    />
